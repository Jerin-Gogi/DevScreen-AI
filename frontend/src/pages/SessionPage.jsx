...
import { getDifficultyBadge } from "../lib/utils.js";
...
function SessionPage() {
  ...
  const joinSessionMutataion = useJoinSession();
  ...
  useEffect(() => {
    ...
    joinSessionMutataion.mutate(id, { onSuccess: refetch });
  ...
  const handleRunCode = async function () {
    setIsRunning(true);
    setOutput(null);
