      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            <button className="group px-6 py-3 bg-linear-to-r from-primary to-secondary rounded-sm text-white font-semibold text-sm shadow-lg hover:shadow-lg transition-all duration-200 hover:scale-105 flex items-center gap-2 cursor-pointer">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-6xl lg:7xl font-black leading-tight">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              ...
              <br /> pair programming. Connect face-to-face, code in real-time,
              and <br />
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Crystal clear audio and video for seemless communication during
                interviews
              </p>
            </div>
          </div>
